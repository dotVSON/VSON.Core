...
namespace VSON.Core
{
    ...
    {
        public static bool AttributesChanged(Component componentA, Component componentB)
        {
        ...
        private static void PrivateMethod()
        {
            ...
            /*VsonDocument documentA = VsonDocument.DeserializeFromFile<VsonDocument>(@"A:\Repositories\ModfiveLabs\VSON\.local\Trials\Sample_01_SerializeAdditionComponent.vson");
